            ...
            <div className="landing-pilot-inner">
              ...
              <div className="landing-pilot-form">
                <div className="landing-form-card">
                  ...
                  <p className="landing-soon">Interested but not invited yet? Leave your details and we&apos;ll contact you.</p>
                  <PilotForm />
                </div>
              </div>
...
function LandingStyles() {
  return (
    <style>{`
      ...
      .landing-honeypot{position:absolute!important;width:1px!important;height:1px!important;overflow:hidden!important;clip:rect(0 0 0 0)!important;white-space:nowrap!important}.landing-f-grid{display:grid;grid-template-columns:1fr 1fr;gap:.9rem}.landing-field label{display:block;font-weight:700;font-size:.86rem;margin-bottom:.35rem}.landing-field label span{font-weight:400;color:var(--ink-soft)}.landing-field input,.landing-field select{width:100%;font:inherit;font-size:1rem;color:var(--ink);background:var(--cream);border:1.5px solid var(--line);border-radius:12px;padding:.75rem .9rem;min-height:52px}.landing-submit{width:100%;margin-top:1rem}.landing-f-privacy{display:flex;gap:.5rem;align-items:center;font-size:.82rem;color:var(--ink-soft);margin-top:.9rem}.landing-account-link{font-size:.86rem;color:var(--ink-soft);margin:.8rem 0 0}.landing-account-link a{color:var(--green-dark);font-weight:800}.landing-form-status{margin-top:1rem;padding:.9rem 1.1rem;border-radius:12px;font-weight:700;font-size:.95rem}.landing-form-status.ok{background:var(--green-tint);color:var(--green-dark)}.landing-form-status.err{background:#FBEDED;color:#8C2B2B}
